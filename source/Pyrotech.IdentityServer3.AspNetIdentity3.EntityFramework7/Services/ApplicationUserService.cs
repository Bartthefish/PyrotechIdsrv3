...
{
    public class ApplicationUserService<TUser> : UserServiceBase 
        where TUser : IdentityUser
    {
        ...
        public ApplicationUserService(UserManager<TUser> userManager, AspNetIdentityOptions options)
        {
        ...
        #region Overrides of UserServiceBase
